...
from dictionary.views import phrases, phrase, search, new_phrase, add_translation, vote_translation, delete_phrase, remove_translation, describe_phrase, approve_translation, export_json
...
urlpatterns = [
  ...
  url(r'^describe/(?P<phrase>\d+)$', describe_phrase, name='dictionary-describe'),
